...
const Status = ({uniqId, svg= null, setReLoad, setLoading, InputModificado, tamInput=null, type, lebelInput, estiloBtnContinuar, labelBtnContinuar, error, handler, titulo, textColor, borderColorSelect, borderColError, borderCol, backGraundInput, min=4, max=10, btn=false, contenBtn = null, estiloTitulo="text-[16px]", estiloError="text-red-600 text-[10px] text-center mt-3 px-1 mb-3"})=>{
